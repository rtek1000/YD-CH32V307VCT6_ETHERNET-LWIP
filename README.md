...
- - Code adapted for the YD-CH32V307VCT6 board with the help of Gemini (Google AI) and ChatGPT. Original LWIP code [here](https://github.com/rtek1000/wch-ch32v307-lwip).
...
- - The [WCH-LinkE programmer](https://raw.githubusercontent.com/rtek1000/YD-CH32V307VCT6_ETHERNET-LWIP/refs/heads/main/IMG/WCH-LinkE-1.png) can operate as a USB serial adapter (RX/TX) for debugging the program via the Putty terminal.
