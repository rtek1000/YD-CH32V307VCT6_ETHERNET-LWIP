...
- - The CH32V307VCT6 can be configured to operate in different operating modes with different ROM/RAM sizes. Configuration may be required via the WCH-LinkUtility program. (See /vendor/Ld/Link.ld file)
